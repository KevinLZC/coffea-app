  ...
  return (
    <>
      <div className='flex justify-center pt-12'>
        <span className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-center'>Nos encontramos en...</span>
      </div>
      <div className='lg:pt-12 flex max-lg:flex-col items-center justify-center space-x-8 lg:pb-10 md:pb-8'>
        ...
        <div className='lg:flex-col lg:my-auto lg:w-[600px]'>
          ...
          <div className='flex justify-center pt-10 pl-10 pr-10 pb-5'>

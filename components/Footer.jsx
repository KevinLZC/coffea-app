...
export function Footer () {
  return (
    <footer className=' bg-gray-100 flex justify-center lg:gap-40 md:gap-16 sm:gap-8 gap-4 items-center lg:h-48 md:h-32 text-gray-500 rounded-t-2xl space-y-4'>
      <div>
      ...
      <div className='flex flex-col items-center text-center lg:space-y-4 md:space-y-2 sm:space-x-1 lg:text-xl md:text-lg text-xs'>
